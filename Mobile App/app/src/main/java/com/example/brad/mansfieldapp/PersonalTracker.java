...
public class PersonalTracker extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle)
    {
        ...
        setContentView(R.layout.personal_tracker);
        ...
        for(int i = 0; i < kpis.size(); i++) {
            ...
            try {
                String result = sql.execute("USERPERFORMANCEKPI", "difference:" + name + ":" + timescale + ":" + Storage.getInstance().uid).get();
