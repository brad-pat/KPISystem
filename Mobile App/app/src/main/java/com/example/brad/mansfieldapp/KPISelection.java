...
public class KPISelection extends AppCompatActivity {
    ...
    private void setup() {
        ...
        for(int i = 0; i < kpis.size(); i++) {
            ...
            final String kpitxt = titles.get(i).getText().toString();
            card.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(getApplicationContext(), KPISubSelection.class);
                    intent.putExtra("kpi", kpitxt);
